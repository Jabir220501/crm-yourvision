    ...
    <div class="fixed inset-0 z-[100] flex flex-col items-center justify-center overflow-hidden px-4 py-6 sm:px-5"
        ...
        <div class="relative w-full max-w-lg origin-top rounded-lg bg-white transition-all duration-300 dark:bg-navy-700"
            ...
            <div class="px-4 py-4 sm:px-5">
                <form class="mt-4 space-y-4" action="./handlers/user/createUser.php" method="post">
                    <label class="block">
                        <span>Select Role</span>
                        <select x-init="$el._tom = new Tom($el)" class="mt-1.5 w-full required" multiple
                            placeholder="Select a role..." autocomplete="off" name="role_id[]">
                    ...
                    <label class="block">
                        ...
                        <input
                            class="form-input mt-1.5 w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                            placeholder="URL Address" name="website_url" type="text" />
                    </label>
