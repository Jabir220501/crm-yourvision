                    ...
                    <div class="flex flex-col justify-between sm:flex-row">
                        ...
                        <div class="mt-4 text-center sm:m-0 sm:text-right">
                            ...
                            <div class="space-y-1 pt-2">
                                ...
                                <p>
                                    Created: <span class="font-semibold"><label class="relative flex">
                            ...
                            <div class="space-y-1 pt-2">
                                ...
                                <div>
                                    <label class="block">
                                        <input
                                            class="form-input w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                            placeholder="Enter Address" type="address" />
                                    </label>
                                </div>
                                </p>
                            </div>
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                <label class="block">
                                                    <input
                                                        class="form-input w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                                        placeholder="Enter Item Description" type="text" />
                                                </label>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="w-3/12 whitespace-nowrap px-4 py-3 text-right sm:px-5">
                                        <label class="block">
                                            <input
                                                ...
                                                placeholder="Enter Hours" type="number" />
                                        </label>
                                    </td>
                                    <td class="w-3/12 whitespace-nowrap px-4 py-3 text-right sm:px-5">
                                    <label class="block">
