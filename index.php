...
<body x-data class="is-header-blur" x-bind="$store.global.documentBody">
    <!-- App preloader-->
    <?php
    include './components/ui/preloader.php'
        ?>
    ...
    <div id="root" class="min-h-100vh flex grow bg-slate-50 dark:bg-navy-900" x-cloak>
        ...
        <main class="main-content w-full pb-8">
            <div
                ...
                <?php
                include './components/crm/project_status/project_status.php'
                ?>
                <div class="col-span-12 lg:col-span-4">
            ...
            <div
                ...
                <div
                    ...
                    <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                        <div class="flex items-center justify-between space-x-2">
                            <div class="flex items-center space-x-3">
                                <div class="avatar">
                                    <img class="mask is-squircle" src="./assets/images/200x200.png" alt="image" />
                                </div>
                                <div>
                        ...
                        <div class="flex justify-between">
                            <div class="flex space-x-2">
                                <img x-tooltip="'Award Level 1'" class="h-6 w-6" src="./assets/images/awards/award-19.svg"
                                    alt="avatar" />
                                <img x-tooltip="'Award Level 2'" class="h-6 w-6" src="./assets/images/awards/award-2.svg"
                                    alt="avatar" />
                                <img x-tooltip="'Award Level 3'" class="h-6 w-6" src="./assets/images/awards/award-5.svg"
                                    alt="avatar" />
                            </div>
                            <button
                    ...
                    <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                        ...
                        <div class="flex justify-between">
                            <div class="flex space-x-2">
                                <img x-tooltip="'Award Level 1'" class="h-6 w-6" src="./assets/images/awards/award-1.svg"
                                    alt="avatar" />
                                <img x-tooltip="'Award Level 2'" class="h-6 w-6" src="./assets/images/awards/award-6.svg"
                                    alt="avatar" />
                                <img x-tooltip="'Award Level 3'" class="h-6 w-6" src="./assets/images/awards/award-9.svg"
                                    alt="avatar" />
                            </div>
                            <button
                                class="btn -mr-1.5 h-8 w-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                    ...
                    <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                        ...
                        <div class="flex justify-between">
                            <div class="flex space-x-2">
                                <img x-tooltip="'Award Level 2'" class="h-6 w-6" src="./assets/images/awards/award-14.svg"
                                    alt="avatar" />
                                <img x-tooltip="'Award Level 3'" class="h-6 w-6" src="./assets/images/awards/award-13.svg"
                                    alt="avatar" />
                            </div>
                            <button
                                class="btn -mr-1.5 h-8 w-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                    ...
                    <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                        ...
                        <div class="flex justify-between">
                            <div class="flex space-x-2">
                                <img x-tooltip="'Award Level 2'" class="h-6 w-6" src="./assets/images/awards/award-15.svg"
                                    alt="avatar" />
                                <img x-tooltip="'Award Level 3'" class="h-6 w-6" src="./assets/images/awards/award-13.svg"
                                    alt="avatar" />
                            </div>
                    ...
                    <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                        ...
                        <div class="flex justify-between">
                            <div class="flex space-x-2">
                                ...
                                <img x-tooltip="'Award Level 3'" class="h-6 w-6" src="./assets/images/awards/award-5.svg"
                                    alt="avatar" />
                                <img x-tooltip="'Award Level 3'" class="h-6 w-6" src="./assets/images/awards/award-25.svg"
                                    alt="avatar" />
                            </div>
                            <button
                                class="btn -mr-1.5 h-8 w-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                    ...
                    <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                        ...
                        <div class="flex justify-between">
                            <div class="flex space-x-2">
                                <img x-tooltip="'Award Level 2'" class="h-6 w-6" src="./assets/images/awards/award-1.svg"
                                    alt="avatar" />
                                <img x-tooltip="'Award Level 3'" class="h-6 w-6" src="./assets/images/awards/award-24.svg"
                                    alt="avatar" />
                                <img x-tooltip="'Award Level 3'" class="h-6 w-6" src="./assets/images/awards/award-30.svg"
                                    alt="avatar" />
                            </div>
                            <button
                                class="btn -mr-1.5 h-8 w-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
